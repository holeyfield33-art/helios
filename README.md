...
Positive vectors carry a frozen SHA-256 hash; negative vectors verify that
invalid inputs are rejected (no hash expected).

| Vector | Description | SHA-256 Content Hash (64 chars) |
|--------|-------------|--------------------------------|
| POS-001 | Basic memory object with all standard fields | `c3262407645dcdbd1cede212fa0448a3adb2f915f762540c32e0050bbf65e781` |
| POS-002 | Keys sorted lexicographically regardless of input order | `694cafaa80dd0121a4c4415ac44793fee17104d02756b3c1456dd79fc467c1d0` |
| POS-003 | NFC normalization produces consistent hash for NFD input | `d7b4f1c46600c6b7f6733e866455cfa3c5646b6e63625a2107a6a57a36be486c` |
| POS-004 | Relationships sorted by key then type | `5e43f9576ec448e9111856b8e0f95593e4aa427ba9ec71cb3a6b574a91719558` |
| POS-005 | Valid UTC millisecond timestamp with native boolean value | `84c6d544a9ee3b9c1bd48a17d8835f25a7df62cd520f78f12fa49810b9e35945` |
| NEG-001..NEG-012 | Rejection tests (floats, nulls, out-of-range ints, bad timestamps, schema version) | — |
...
Cross-language match: 17/17 identical hashes
...
├── test_vectors/vectors.json        # 17 frozen test vectors (5 positive, 12 negative)
├── spec/
...
- **Cross-language:** 17/17 vectors verified in Docker
